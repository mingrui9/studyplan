...
```{r}
scenarios <- evaluate_budget_scenarios(
...
As you can see, the table highlights key trade-offs. For instance, a total sample size of 140 allows for 30 participants to be in the MRI subgroup, while a total sample size of 160 allows for 20 participants. This table is a powerful tool for making an informed decision about the study design.
